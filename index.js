/**
 * AngelGuard Anti Nuke: Private Mode
 * https://github.com/1Know
 * Discord: Know#3868
 */
...
const Title = String.raw`
                            ...
                            ╚═════╝ ╚══════╝╚═╝  ╚═╝╚═════╝ ╚══════╝╚══════╝╚═╝
                                  ...
                                  Anti Nuke | Know | Desenvolvedor: ${author}
...
client.on("guildBanAdd", async (guild, user) => {
    ...
    fetchingLogsErrors.catch(() => {
        return console.log(red('Sem permissão para efetuar essa ação. To Log Entry: Ban'));
    })
...
client.on("guildMemberRemove", async member => {
    ...
    FetchingLogs.catch(() => {
        return console.log(red('Sem permissão para efetuar essa ação. To Log Entry: Kick'));
    })
...
client.on("channelCreate", async (channel) => {
    ...
    FetchingLogsErrors.catch(() => {
        return console.log(red('Sem permissão para efetuar essa ação. To Log Entry: Create Channel'));
    })
...
client.on("guildMemberAdd", async (member) => {
    ...
    FetchingLogsErrors.catch(() => {
        return console.log(red('Sem permissão para efetuar essa ação. To Log Entry: Bot Add'));
    })
...
client.on("roleCreate", async (role) => {
    ...
    FetchingLogs.catch(() => {
        return console.log(red('Sem permissão para efetuar essa ação. To Log Entry: Role Create'));
    })
...
client.on("roleUpdate", async (oldRole, newRole) => {
    ...
    FetchingLogs.catch(() => {
        return console.log(red('Sem permissão para efetuar essa ação. To Log Entry: Role Update'));
    })
...
client.on("guildMemberUpdate", async (oldMember, newMember) => {
    ...
    FetchingLogs.catch(() => {
        return console.log(red('Sem permissão para efetuar essa ação. To Log Entry: Member Role Update'));
    })
